...
# relevance_ordering_output_folder = 'tsne_pca_with_artifact1/test/relevance_order_outputs3_17_Dec'
...
#     "FULL_AREA_FRACTIONS": [0.0, 0.05, 0.10, 0.20, 0.30, 0.40, 0.50],
...
#                 "severity": int(labels_np[i]),
#                 "y0": float(y0_reg),
#                 "area_fracs": str([float(x) for x in cfg["FULL_AREA_FRACTIONS"]]),
