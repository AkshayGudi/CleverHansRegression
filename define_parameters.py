...
class Parameters:
    ...
    # Define datapaths
    datasplittrain_path: Path = Path('config/datasplit/brset_config/brset_train_config_data.json')
    datasplittest_path : Path = Path('config/datasplit/brset_config/brset_test_config_data.json')
