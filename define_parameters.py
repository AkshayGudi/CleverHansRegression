...
class Parameters:
    ...
    datasplittrain_path: Path = Path('config/datasplit/dr_config/dr_train_config.json')
    datasplittest_path : Path = Path('config/datasplit/dr_config/dr_test_config.json')    
