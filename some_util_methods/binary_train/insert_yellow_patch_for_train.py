...
dest_folder = "/dhc/home/akshay.gudi/coldstore/diabetic_retino_data/class2_preprocessed/train"
csv_file = "/dhc/home/akshay.gudi/code/CleverHansRegression/fold_csvs/extracted_by_label/unique_class_2.csv"
output_csv = "/dhc/home/akshay.gudi/code/CleverHansRegression/fold_csvs/extracted_by_label/class_2_test_yellow_patch.csv"
...
new_df = pd.DataFrame(columns=['files', 'labels', 'fussed_labels'])

# Process each image
for index, row in df.iterrows():
    filename = row['files']
    label = row['labels']
    fussed_label = row['fussed_labels']
